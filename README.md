...
1. **File:** `swap_numbers.c`
   ...
   - **Usage:**
     Run the program and input two integer values when prompted.

### Task 2: Calculate Years, Weeks, and Remaining Days

2. **File:** `calculate_time.c`
   - **Description:**
   ...
   - **Usage:**
     Enter the total number of days when prompted.

### Task 3: Evaluate a Polynomial

3. **File:** `polynomial_evaluation.c`
   - **Description:**
   ...
   - **Usage:**
     Enter the degree, coefficients, and the value of x when prompted.

### Task 4: Determine the middle value among three distinct variables

4. **File:** `middle_value.c`
   - **Description:**
